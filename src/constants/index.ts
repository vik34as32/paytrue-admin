...
/** Role-based sidebar: super admin = platform ops; admin = downline + wallet (no add balance) */
export const SIDEBAR_ITEMS = [
  ...
  { label: "Dashboard", href: ROUTES.dashboard, icon: "dashboard", roles: ["admin", "master_distributor", "distributor", "retailer"] as const },
  ...
  { label: "Change Password", href: ROUTES.adminChangePassword, icon: "profile", roles: ["admin"] as const },
  ...
  { label: "Master Distributor", href: ROUTES.masterDistributor, icon: "masterDistributor", roles: ["admin"] as const },
  { label: "Distributor", href: ROUTES.distributor, icon: "distributor", roles: ["admin"] as const },
  { label: "Retailer", href: ROUTES.retailer, icon: "retailer", roles: ["admin"] as const },
  { label: "Transactions", href: ROUTES.transactions, icon: "transactions", roles: ["super_admin", "admin", "master_distributor", "distributor"] as const },
  { label: "Balance Transfer", href: ROUTES.balanceTransfer, icon: "transfer", roles: ["admin", "master_distributor", "distributor"] as const },
  { label: "Fund Request", href: ROUTES.requests, icon: "requests", roles: ["super_admin", "admin", "master_distributor", "distributor", "retailer"] as const },
  { label: "Reports", href: ROUTES.reports, icon: "reports", roles: ["super_admin", "admin", "master_distributor", "distributor"] as const },
  { label: "Ledger", href: ROUTES.ledger, icon: "ledger", roles: ["super_admin", "admin", "master_distributor", "distributor"] as const },
  { label: "Hierarchy", href: ROUTES.hierarchy, icon: "hierarchy", roles: ["super_admin", "admin"] as const },
  { label: "History", href: ROUTES.history, icon: "history", roles: ["super_admin", "admin", "master_distributor", "distributor", "retailer"] as const },
  { label: "Profile", href: ROUTES.profile, icon: "profile", roles: ["super_admin", "admin", "master_distributor", "distributor", "retailer"] as const },
  { label: "Settings", href: ROUTES.settings, icon: "settings", roles: ["super_admin", "admin", "master_distributor", "distributor", "retailer"] as const },
] as const;
