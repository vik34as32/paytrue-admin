...
export const ROUTES = {
  ...
  adminDistributors: "/admin/distributors",
  adminCreateDistributor: "/admin/create-distributor",
  adminRetailers: "/admin/retailers",
  adminCreateRetailer: "/admin/create-retailer",
...
export const ADMIN_SIDEBAR_ITEMS = [
  ...
  { label: "Distributors", href: ROUTES.adminDistributors, icon: "distributor" as const },
  { label: "Retailers", href: ROUTES.adminRetailers, icon: "retailer" as const },
