...
export default function RetailerPage() {
  ...
  const { data, total, isLoading, error } = useAppSelector(selectAdminRetailers);
    ...
    return (
      <div className="page-container">
        <PageHeader
          breadcrumb="Admin"
          title="Retailers"
          subtitle="Retailers in your downline"
        />
        {error && (
  ...
  return (
    <div className="page-container">
      <PageHeader breadcrumb="Network" title="Retailer" subtitle="Retailer network" />
      <Card>
