...
import { canViewHierarchy } from "@/lib/hierarchy/permissions";

interface HierarchyManagementShellProps {
  children: React.ReactNode;
}

export function HierarchyManagementShell({
  children,
}: HierarchyManagementShellProps) {
